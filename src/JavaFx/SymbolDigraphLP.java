...
public class SymbolDigraphLP {
    ...
    double getWeightBetween(String v1, String v2) {
        int i1 = st.get(v1);
        int i2 = st.get(v2);
        for(DirectedEdge e: graph.adj(i1))
            if(e.to() == i2)
                return e.weight();
        return 0;
    }
     ...
     */
    /*
    public SymbolDigraphLP(String filename, String delimiter) {
...
*/
    ...
    public static void main(String[] args) {
        ...
        SymbolDigraphLP sg = new SymbolDigraphLP(filename, delimiter);
